...
public class TC002_Admin_SearchEmployee_NotExist {
    ...
    public void TC002_Admin_SearchEmployee_NotExist() {
        ...
        driver.findElement(By.xpath("//div[@class = 'oxd-input-group oxd-input-field-bottom-space']/div/input")).sendKeys("XYZ");
        driver.findElement(By.xpath("//div[@class = 'oxd-form-actions']/button[@type = 'submit']")).click();
        System.out.println("step 5 & 6 completed");

        //Step 7
        Reporter.log("Verify username does not exists in table");
        wait.until(ExpectedConditions.visibilityOf(driver.findElement(By.xpath("//div[@class='orangehrm-container']"))));
        driver.findElement(By.xpath("//div[@class='orangehrm-container']")).click();
        wait.until(ExpectedConditions.visibilityOf(driver.findElement(By.xpath("//div[@class='orangehrm-horizontal-padding orangehrm-vertical-padding']/ span"))));
        String valueSearched = driver.findElement(By.xpath("//div[@class='orangehrm-horizontal-padding orangehrm-vertical-padding']/ span")).getText();
        System.out.println(valueSearched);
        Assert.assertEquals(valueSearched,"No Records Found");
